										...
										<div id="carouselExample" className="carousel slide" data-ride="carousel">
											...
											<div className="carousel-inner">
												<div className="carousel-item active">
													<img src="https://placehold.co/728x400/c9d2e3/212837" alt="" className="d-block w-100" />
								...
								<Card>
									<CardBody>
										<div className="d-flex align-items-start">
											<img src="https://placehold.co/128x128/c9d2e3/212837" alt="" width="64" className="rounded" />
											<div className="ms-3">
