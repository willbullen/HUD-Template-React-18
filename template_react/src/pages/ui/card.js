										...
										<div className="row">
											<div className="col-xl-6">
												...
												<Card className="mb-3">
													<CardBody className="pb-0">
														<img src="https://placehold.co/600x400/c9d2e3/212837" alt="" className="card-img-top" />
													</CardBody>
													<CardBody>
														<h5 className="card-title">Card title</h5>
											...
											<div className="col-xl-6">
												...
												<Card className="p-3 mb-3">
													<img src="https://placehold.co/600x750/000000/ffffff" alt="" className="card-img" />
											...
											<CardBody>
												<div className="row gx-0 align-items-center">
													<div className="col-md-4">
														<img src="https://placehold.co/480x360/c9d2e3/212837" alt="" className="card-img rounded-0" />
													</div>
